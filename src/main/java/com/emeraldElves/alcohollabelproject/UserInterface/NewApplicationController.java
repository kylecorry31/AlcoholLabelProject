...
//        if (alcoholInfo.getType() == AlcoholType.BEER) {
//            pTypeSelect.setValue("Malt Beverages");
//        } else if (alcoholInfo.getType() == AlcoholType.WINE) {
//            pTypeSelect.setValue("Wine");
//        } else {
//            pTypeSelect.setValue("Distilled Spirits");
//        }
//        //fanciful name
//        alcoholName.setText(alcoholInfo.getFancifulName());
//        //brand name
//        brandNameField.setText(alcoholInfo.getBrandName());
//        //Alcohol Content
//        if (alcoholInfo.getAlcoholContent() != 0.0) {
...
//        //Wine info things
//        if (alcoholInfo instanceof WineInfo) {
//            WineInfo wineInfo = (WineInfo) alcoholInfo;
//            //Vintage Year
//            if (wineInfo.getVintageYear() != -1) {
//                wineVintageYearField.setText("" + wineInfo.getVintageYear());
//            }
//            //pH
//            if (wineInfo.getPH() != -1.0) {
//                pHLevelField.setText("" + wineInfo.getPH());
//            }
//            //varietals
//            varietalText.setText(wineInfo.getGrapeVarietal());
//            //appellation
//            appellationText.setText(wineInfo.getAppellation());
//        }
//        //Image
//        if (!imageURL.equals("")) {
...
//        }
//
//        if (application.getApplication().getAlcohol().getType() == AlcoholType.BEER) {
//            pTypeSelect.setValue("Malt Beverages");
//        } else if (application.getApplication().getAlcohol().getType() == AlcoholType.WINE) {
//            pTypeSelect.setValue("Wine");
//        } else if (application.getApplication().getAlcohol().getType() == AlcoholType.DISTILLEDSPIRITS) {
//            pTypeSelect.setValue("Distilled Spirits");
//        }
//
//        alcoholName.setText(String.valueOf(application.getApplication().getAlcohol().getFancifulName()));
...
//        if (application.getApplication().getAlcohol() instanceof WineInfo) {
//            WineInfo wineInfo = (WineInfo) application.getApplication().getAlcohol();
//            wineVintageYearField.setText(String.valueOf(wineInfo.getVintageYear()));
//            pHLevelField.setText(String.valueOf(wineInfo.getPH()));
//            varietalText.setText(String.valueOf(wineInfo.getGrapeVarietal()));
//            appellationText.setText(String.valueOf(wineInfo.getAppellation()));
//        }
//    }
//
...
//                info = new WineInfo(Double.valueOf(alcContent), alcName, brandName, pSource, serialNum, formula, pH, vintageYr, varietal, appellation);
//            } else if (alcType == AlcoholType.BEER) {
//                info = new BeerInfo(Double.valueOf(alcContent), alcName, brandName, pSource, serialNum, formula);
//            } else {
//                info = new SpiritInfo(Double.valueOf(alcContent), alcName, brandName, pSource, serialNum, formula);
//            }
//
//
...
//
//            ApplicationInfo appInfo = new ApplicationInfo(newDate, appManInfo, info, extraInfo, appType);
//
...
//        String stateOnly;
//        if (certOfExemption.isSelected()) {
//            stateOnly = stateSelect.getValue().toString();
//        }//Maybe change this
//        else {
//            stateOnly = "";
//        }
...
//            alcoholContent = "";
//        } else {
//            alcoholContent = alcoholContentField.getText();
//        }
//        //fanciful
//        if (alcoholName.getText().isEmpty()) {
//            fanciful = "";
//        } else {
//            fanciful = alcoholName.getText();
//        }
//        //brand
//        if (brandNameField.getText().isEmpty()) {
//            brand = "";
//        } else {
//            brand = brandNameField.getText();
//        }
//        //origin
//        if (pSourceSelect.getValue().equals("Domestic")) {
...
//            serialNumber = "";
//        } else {
//            serialNumber = serialText.getText();
//        }
//        //formula
//        if (formulaText.getText().isEmpty()) {
//            formula = "";
